...
**Entregas 2 e 3 (tela do caso reorganizada, Motor de Fluxo) — ainda não iniciadas.**
...
2. **Próximo passo mais provável**: a Onda 3 e a Agenda independente (entrega 1 da reorganização adiantada, seção 8.7) estão em produção. Pedir pra cliente testar a Agenda clicando na UI de verdade, e seguir pra **entrega 2** (tela do caso reorganizada — linha do tempo única) — mas **perguntar antes de presumir**, ela muda de prioridade com frequência.
