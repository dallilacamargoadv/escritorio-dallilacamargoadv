...
export function CategoriasDespesaPessoalEditor({
  categorias,
  onChange,
}: {
  ...
  async function handleAddCategoria() {
    ...
    setCriando(true);
    try {
      const res = await fetch("/api/admin/despesa-categorias-pessoal", {
        method: "POST",
  ...
  async function handleRenameCategoria(categoriaId: string, nome: string) {
    ...
    await fetch(`/api/admin/despesa-categorias-pessoal/${categoriaId}`, {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ nome }),
    });
  ...
  async function handleDeleteCategoria(categoriaId: string) {
    ...
    await fetch(`/api/admin/despesa-categorias-pessoal/${categoriaId}`, { method: "DELETE" });
  }

  async function handleAddSubcategoria(categoriaId: string, nome: string) {
    const res = await fetch(
      `/api/admin/despesa-categorias-pessoal/${categoriaId}/subcategorias`,
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ nome }),
  ...
  async function handleDeleteSubcategoria(categoriaId: string, subId: string) {
    ...
    await fetch(
      `/api/admin/despesa-categorias-pessoal/${categoriaId}/subcategorias/${subId}`,
      { method: "DELETE" },
    );
  }
